...
public class CustomContactListener implements ContactListener {
	...
	public void beginContact(Contact contact) {
		applyCallback(contact, (PhysicsEntity ea, PhysicsEntity eb, boolean sensorA, boolean sensorB) -> {
			if (sensorA) {
	...
	public void preSolve(Contact contact, Manifold manifold) {
		applyCallback(contact, (PhysicsEntity ea, PhysicsEntity eb, boolean sensorA, boolean sensorB) -> ea
				.preSolve(eb, contact, manifold));
	}
	...
	public void postSolve(Contact contact, ContactImpulse contactImpulse) {
		applyCallback(contact, (PhysicsEntity ea, PhysicsEntity eb, boolean sensorA, boolean sensorB) -> ea
				.postSolve(eb, contact, contactImpulse));
	}

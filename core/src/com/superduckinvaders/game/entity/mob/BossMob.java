...
/**
 * Ah yes, the final mecha-swan boss. Have you met him yet?
 * Very bulky, but he doesn't move much.
 */
public class BossMob extends RangedMob {
    ...
    public BossMob(Round parent, float x, float y) {
        ...
        range = Float.POSITIVE_INFINITY; // Hacky, but this way he's definitely not gonna move.
    }
}
